...
class CrimeFeed extends StatefulWidget {
...
class _HomepageState extends State<CrimeFeed> {
String crime;
...
Widget build(BuildContext context) {
  return Scaffold(
    appBar: AppBar(title: Text('Crime Feed',
    ...
    body: StreamBuilder(
       stream: FirebaseFirestore.instance.collection('crimefeed').snapshots(),
